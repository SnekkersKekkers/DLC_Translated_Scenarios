...
MsgDisp("Nora","Success isn't here today?");
MsgDisp("主人公","Huh?
S-Success...?");
ChEye(34,0);
ChMouth(34,2);
VoicePlay("D031101000_34_010");
MsgDisp("Nora","Yeah, pretty good username, right?
I came up with it.");
...
MsgDisp("Nora","Oh, that's kind of funny...");
...
MsgDisp("Nora","I've got plans after this, so I'm heading
out.
Later, Success.");
MsgClose();
...
That guy's pretty interesting, huh?");
...
MsgDisp("Onari","The friendship actually became real.");
...
You said \"too,\" so that means you like me
as well, right?");
MsgDisp("主人公","Huh∋");
ChEye(11,0);
ChMouth(11,4);
...
practicing for the certification?");
